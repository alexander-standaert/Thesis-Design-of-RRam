...
legend('Vt mismatch Mup','Vt mismatch Mupbar','Vt mismatch Mdown','Vt mismatch Mdownbar','Vt mismatch Mtop','Vt mismatch Mdown','Vt mismatch Mpassn','Vt mismatch Mpassp','Vt mismatch Mpassnbar','Vt mismatch Mpasspbar')
figure
hold all
for i=2:4:20
...
legend('\beta mismatch Mup','\beta mismatch Mupbar','\beta mismatch Mdown','\beta mismatch Mdownbar','\beta mismatch Mtop','\beta mismatch Mdown','\beta mismatch Mpassn','\beta mismatch Mpassp','\beta mismatch Mpassnbar','\beta mismatch Mpasspbar')
