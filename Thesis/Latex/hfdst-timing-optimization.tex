...
\begin{figure}[!ht]
  ...
  \caption[Delay, energieverbruik en oppervlakte van alle geheugenconfiguraties]{Delay, energieverbruik en oppervlakte van verschillende geheugenconfiguraties van 4Mbit. Kleinste transistor-gate-oppervlakte is $0.009mm^{2}$, grootste transistor-gate-oppervlakte is $0.68mm^{2}$}
